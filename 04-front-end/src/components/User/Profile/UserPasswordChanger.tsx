...
export default function UserPasswordChanger(props: IUserPasswordChangerProperties) {
    const [newPassword, setNewPassword] = useState<IInputData>({ value: "", isValid: true });
    const [confirmNewPassword, setConfirmNewPassword] = useState<IInputData>({ value: "", isValid: true });
    ...
    function doSaveDetails() {
        ...
        api("put", "/api/user/" + props.user.userId, "activeUser", { password: newPassword.value })
            .then(res => {
                if (res.status !== 'ok') {
                ...
                <div className="card-text">
                    <div className="form-group mb-3">
                        ...
                        <div className="input-group">
                            <input type="password" className={"form-control" + (!newPassword.isValid ? " is-invalid" : '')} maxLength={128} value={newPassword.value}
                    ...
                    <div className="form-group mb-3">
                        ...
                        <div className="input-group">
                            <input type="password" className={"form-control" + (!confirmNewPassword.isValid ? " is-invalid" : '')} maxLength={128} value={confirmNewPassword.value}
