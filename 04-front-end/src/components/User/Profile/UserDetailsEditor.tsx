...
export default function UserDetailsEditor(props: IUserDetailsEditorProperties) {
    const [username, setUsername] = useState<IInputData>({ value: props.user.username, isValid: true });
    ...
    function doSaveDetails() {
        ...
        api("put", "/api/user/" + props.user.userId, "user", { username: username.value })
            .then(res => {
                if (res.status !== 'ok') {
            ...
            .then(user => {
                ...
                AppStore.dispatch({ type: "auth.update", key: "identity", value: user.username });
                ...
                <div className="card-text">
                    <div className="form-group mb-3">
                        ...
                        <div className="input-group">
                            <input className={"form-control" + (!username.isValid ? " is-invalid" : '')} maxLength={32} value={username.value}
