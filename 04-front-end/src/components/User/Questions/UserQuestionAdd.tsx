...
type TSetAnswerIsCorrect = {
  type: "addQuestionForm/setAnswerIsCorrect";
...
function AddQuestionFormReducer(
  oldState: IAddQuestionFormState,
  action: AddQuestionFormAction
): IAddQuestionFormState {
  switch (action.type) {
    ...
    case "addQuestionForm/addAnswer": {
      ...
      return {
        ...
        answers: [
          ...
          { answerId: action.value, isCorrect: true },
        ],
      };
    }
...
export default function UserQuestionAdd() {
  ...
  const doAddQuestion = () => {
    api("post", "/api/question", "activeUser", formState)
      .then((res) => {
        if (res.status !== "ok") {
          throw new Error(
                ...
                <input
                  ...
                  onChange={(e) =>
                    dispatchFormStateAction({
                      type: "addQuestionForm/setGameId",
                    ...
                    <div className="col col-3">
                      {answerData ? (
                        <FontAwesomeIcon
                          onClick={() =>
                            dispatchFormStateAction({
                              type: "addQuestionForm/removeAnswer",
                        ...
                        <FontAwesomeIcon
                          onClick={() =>
                            dispatchFormStateAction({
                              type: "addQuestionForm/addAnswer",
                              value: answer.answerId,
                            })
                          }
                          icon={faSquare}
