...
export interface IUserQuestionAnswerListUrlParams extends Record<string, string | undefined> {
    qid: string;
}
...
export default function UserQuestionAnswerList() {
    ...
    function UserQuestionAnswerListRow(props: IUserQuestionAnswerListRowProperties) {
        ...
        return (
            <div>
                ...
                <table className="table table-sm table-hover">
                    ...
                    <tbody>
                        {question.answers?.map(answer => <UserQuestionAnswerListRow key={"answer-" + answer.answer.answerId} questionAnswer={answer} />)}
                    </tbody>
                </table>
            </div>
        )
