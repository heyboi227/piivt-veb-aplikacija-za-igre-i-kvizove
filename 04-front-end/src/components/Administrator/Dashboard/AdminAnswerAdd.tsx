...
type AddAnswerFormAction = TSetGameId | TSetAnswerValue;

function AddAnswerFormReducer(
  oldState: IAddAnswerFormState,
  action: AddAnswerFormAction
): IAddAnswerFormState {
  switch (action.type) {
            ...
            <div className="form-group mb-3">
              ...
              <div className="input-group">
                <input
                  ...
                  onChange={(e) =>
                    dispatchFormStateAction({
                      type: "addAnswerForm/setAnswerValue",
                      value: e.target.value,
                    })
                  }
                />
