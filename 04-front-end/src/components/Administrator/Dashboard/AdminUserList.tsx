                        ...
                        {!editUsernameVisible &&
                            <div className="row">
                                ...
                                <div className="col col-3">
                                    <button className="btn btn-primary btn-sm" onClick={() => setEditUsernameVisible(true)}>
                                        Edit
                                    </button>
                                </div>
                            </div>
                        }
                        {editUsernameVisible && <div>
                            ...
                            {newUsername !== props.user.username &&
                                (<button className="btn btn-sm btn-primary" onClick={() => doEditUsername()}>
                                    Edit
                                </button>)}
