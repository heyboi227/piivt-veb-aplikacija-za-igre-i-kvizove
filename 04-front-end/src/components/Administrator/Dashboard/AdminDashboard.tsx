                ...
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="card-text d-grid gap-3">
                            <Link className="btn btn-primary" to="/admin/dashboard/question/list">List all</Link>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="col-12 col-lg-4 col-md-6 col-xl-3 p-3">
                <div className="card">
                    <div className="card-body">
                        ...
                        <div className="card-text d-grid gap-3">
                            <Link className="btn btn-primary" to="/admin/dashboard/answer/list">List answers</Link>
                        </div>
                    </div>
                </div>
            </div>
